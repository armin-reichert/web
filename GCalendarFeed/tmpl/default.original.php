...
<div id="gcf-simple-<?php echo $moduleID ?>" class="gCalFlow" style="height:<?php echo $params->get('gcalHeight') ?> !important; width:<?php echo $params->get('gcalWidth') ?> !important; margin-bottom: <?php echo $params->get('bottomMargin') ?> !important; color: <?php echo $params->get('containerText') ?>;">
	...
	<div class="gcf-item-title-block>
		<a class="gcf-item-link"><span class="gcf-item-date">2012-02-01 09:00</span>:</a>
	...
	<?php if ($showFooter == "show"): ?>
		...
		<?php echo $params->get('footerData') ?>: <span class="gcf-last-update">2012-02-30 20:58</span>
		</div>
	<?php endif ; ?>
</div>
...
jQuery('#gcf-simple-<?php echo $moduleID ?>').gCalFlow({
	...
	<?php endif ; ?>	
	<?php if ($dateFormat == "2") : ?>
	date_formatter: function(d, allday_p) { function pad(n) { return n < 10 ? "0"+n : n; } return pad(d.getDate()) + "<?php echo $dateSeparator ?>" + pad(d.getMonth()+1) + "<?php echo $dateSeparator ?>" + d.getFullYear().toString().substr(<?php echo $params->get('fullYear') ?>) }
	<?php endif ; ?>	
	<?php if ($dateFormat == "3") : ?>
